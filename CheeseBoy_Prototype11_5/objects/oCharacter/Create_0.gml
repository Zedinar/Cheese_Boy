...
enum states {IDLE, WALKING, RUNNING, CROUCHING, CROUCHED, UNCROUCHING}
...
isHoldingFirstJumpInAir = false; //true when initial jump button press is still help after jumping
